document.addEventListener('keydown' , (event)=> {
     ...
     if (key == 65){
     	...
     	audio.currentTime = 0;
     	audio.play();
     	document.getElementById('65').style.backgroundColor ="#00ffff";
     	document.getElementById('65').style.boxShadow ="0px 0px 20px 0px #00ffff "
     	setTimeout(function() {
     ...
     if (key == 83){
     	...
     	audio.currentTime = 0;
     	audio.play();
     	document.getElementById('83').style.backgroundColor ="#00ffff";
     	document.getElementById('83').style.boxShadow ="0px 0px 20px 0px #00ffff "
     	setTimeout(function() {
     ...
     if (key == 68){
     	...
     	audio.currentTime = 0;
     	audio.play();
     	document.getElementById('68').style.backgroundColor ="#00ffff";
     	document.getElementById('68').style.boxShadow ="0px 0px 20px 0px #00ffff "
     	setTimeout(function() {
     ...
     if (key == 70){
     	...
     	audio.currentTime = 0;
     	audio.play();
     	document.getElementById('70').style.backgroundColor ="#cc00ff";
     	document.getElementById('70').style.boxShadow ="0px 0px 20px 0px #cc00ff "
     	setTimeout(function() {
     ...
     if (key == 71){
     	...
     	audio.currentTime = 0;
     	audio.play();
     	document.getElementById('71').style.backgroundColor ="#cc00ff";
     	document.getElementById('71').style.boxShadow ="0px 0px 20px 0px #cc00ff "
     	setTimeout(function() {
     ...
     if (key == 72){
     	...
     	audio.currentTime = 0;
     	audio.play();
     	document.getElementById('72').style.backgroundColor ="#cc00ff";
     	document.getElementById('72').style.boxShadow ="0px 0px 20px 0px #cc00ff "
     	setTimeout(function() {
     ...
     if (key == 74){
     	...
     	document.getElementById('74').style.boxShadow ="0px 0px 20px 0px white "
     	setTimeout(function() {
